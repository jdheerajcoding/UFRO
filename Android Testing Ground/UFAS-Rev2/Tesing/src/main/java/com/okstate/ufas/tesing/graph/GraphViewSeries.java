...
public class GraphViewSeries {
	...
	public GraphViewSeries(GraphView.GraphViewData[] values) {
		description = null;
		style = new GraphViewSeriesStyle();
		this.values = values;
	}

	public GraphViewSeries(String description, GraphViewSeriesStyle style, GraphView.GraphViewData[] values) {
		super();
	...
	public void appendData(GraphView.GraphViewData value, boolean scrollToEnd) {
        GraphView.GraphViewData[] newValues = new GraphView.GraphViewData[values.length + 1];
