...
import com.okstate.ufas.tesing.nav.MapHelperClass;

import java.util.Random;

public class Dashboard3Activity extends FragmentActivity {
...
//			varioView.Set(app.mw.vario * 0.6f);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mapHelperClass = new MapHelperClass((Context)this, ((SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map)).getMap(), 5, 5);
