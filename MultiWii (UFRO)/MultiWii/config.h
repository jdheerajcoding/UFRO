...
/*************************************************************************************************/
  /********************************  PID Controller *********************************/
    ...
    #define YAW_DIRECTION 1     //ben corrected this feb 2014 
 ...
 */
  ...
  /**************************************************************************************/
    ...
    #define GPS_SERIAL 2     //UFRO    // should be 2 for flyduino v2. It's the serial port number on arduino MEGA
    //#define GPS_PROMINI_SERIAL   // Will Autosense if GPS is connected when ardu boots.

    // avoid using 115200 baud because with 16MHz arduino the 115200 baudrate have more than 2% speed error (57600 have 0.8% error)
    #define GPS_BAUD   57600   //UFRO 57600
   ...
   /* GPS protocol 
    ...
    //#define MAG_DECLINIATION  3.96f   //for stillwater, Ok
